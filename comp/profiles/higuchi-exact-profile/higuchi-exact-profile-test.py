...
first_time = True
try:
    disk_np_res = np.load("higuchi-exact-prof-cH"+str(contour_H)+"-N"+str(N)+"-test.npy")
    first_time = False
...
# SAVING
np.save("higuchi-exact-prof-cH"+str(contour_H)+"-N"+str(N)+"-test.npy", disk_np_res)
...
filename = "higuchi-exact-profile-response-contH-%g.png"%contour_H
